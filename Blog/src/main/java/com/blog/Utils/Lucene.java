...
public class Lucene {
    public void createIndexFile(List<RequireOrder> list){
        ...
        try {
            ...
            //鏂囨湰娣诲姞鍐呭�?
                ...
                doc.add(new Field("requirename",list.get(i).getRequire(), Field.Store.YES, Field.Index.ANALYZED));
                doc.add(new Field("requiredate",list.get(i).getCreateTime().toString(), Field.Store.YES, Field.Index.ANALYZED));
                doc.add(new Field("requiretype",list.get(i).getType(), Field.Store.YES, Field.Index.ANALYZED));
                doc.add(new Field("requirestatus",list.get(i).getRequirestatus(), Field.Store.YES, Field.Index.ANALYZED));
                doc.add(new Field("conname",list.get(i).getConusername(), Field.Store.YES, Field.Index.ANALYZED));
                doc.add(new Field("conphone",list.get(i).getPhone(), Field.Store.YES, Field.Index.ANALYZED));
    ...
    public List search(List<RequireOrder> list,String queryString) throws IOException, ParseException, java.text.ParseException {
        ...
        for(ScoreDoc scoreDoc:hits)
        	...
        	Date d=sim.parse(doc.get("requiredate"));
                ...
                order.setRequire(doc.get("requirename"));
                order.setType(doc.get("requiretype"));
                order.setRequirestatus(doc.get("requirestatus"));
                order.setConusername(doc.get("conname"));
                order.setPhone(doc.get("conphone"));
